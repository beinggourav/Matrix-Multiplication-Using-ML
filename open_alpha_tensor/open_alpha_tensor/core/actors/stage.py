...
def actor_prediction(
    ...
    """
    print("Running MCTS(for current actor) to generate next state")
    ...
    while rank < maximum_rank:
        ...
        print("MCTs starts for rank",rank)
